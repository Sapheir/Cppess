 ...
 * @param scaleX: parameters that show if the position on X should increase(1) or decrease(-1) or remains the same(0)
 * @param scaleY: parameters that show if the position on Y should increase(1) or decrease(-1) or remains the same(0)
